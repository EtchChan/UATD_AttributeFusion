...
int main()
{
    ...
    std::string path1 = "D:\\Repo\\UATD\\Dataset\\Processed\\Thorp\\Train\\images\\";
    std::string path2 = "D:\\Repo\\UATD\\Dataset\\Processed\\Gaussian\\Train\\images\\";
    std::string path3 = "D:\\Repo\\UATD\\Dataset\\Training\\images\\";
    ...
    std::vector<int> examples = {347, 505, 7581};
    for (int i : examples)
    {
        // print the progress
